...
def personal_sum(numbers: list | tuple) -> tuple[int | float, int] | None:
    """
    ...
    :param numbers: коллекция чисел или не чисел
...
def calculate_average(numbers: list | tuple) -> float | None:
    """
    Среднее арифметическое всех чисел
    :param numbers: коллекция чисел или не чисел
    :return: сумма всех данных в коллекции numbers, делённая на их количество.
             0, если чисел в коллекции нет.
             None, если numbers - не коллекция
    """
    try:
        numbers_sum, incorrect_data = personal_sum(numbers)
    except TypeError:
        print('В numbers записан некорректный тип данных')
        return None

    try:
        average = numbers_sum / (len(numbers) - incorrect_data)
        return average
